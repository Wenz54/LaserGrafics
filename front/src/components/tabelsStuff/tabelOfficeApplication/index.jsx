...
const TabOfficeApplication = () => {
    ...
    const sizes = [ // Renamed "osnastki" to "sizes" for clarity
        { id: 'size_200x100', name: '200x100', price: 1500, imgSrc: 'resourses/tabel.jpg', artikul: 'officeAppSmall' },
        { id: 'size_300x150', name: '300x150', price: 2200, imgSrc: 'resourses/tabel.jpg', artikul: 'officeAppMedium' },
        { id: 'size_400x200', name: '400x200', price: 3000, imgSrc: 'resourses/tabel.jpg', artikul: 'officeAppLarge' },
        { id: 'size_500x250', name: '500x250', price: 3800, imgSrc: 'resourses/tabel.jpg', artikul: 'officeAppXLarge' },
    ...
    const handleAddToCart = async () => {
        ...
        const productToAdd = {
            ...
            name: `Офисная табличка (Аппликация) (${selectedSizeData?.name || ''})`,
            price: totalPrice,
            quantity: quantity,
            description: 'Офисная табличка с аппликацией для помещений',
            imageUrl: imageUrl,
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.productInfoSection}> {/* General container for text part */}
                        <div className={styles.nazvanie}>
                            <h3>Офисная табличка (Аппликация)</h3>
                            <h4>Для помещений</h4>
                        </div>
