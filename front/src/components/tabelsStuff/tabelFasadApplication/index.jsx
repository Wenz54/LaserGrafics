...
const TabFasadApplication = () => {
    ...
    const sizes = [ // Переименовал "osnastki" в "sizes" для ясности
        { id: 'size_400x300', name: '400x300', price: 3800, imgSrc: 'resourses/tabel.jpg', artikul: '3dLittleApplication' },
        { id: 'size_500x500', name: '500x500', price: 6800, imgSrc: 'resourses/tabel.jpg', artikul: '3dLittlePlusApplication' },
        { id: 'size_500x700', name: '500x700', price: 9500, imgSrc: 'resourses/tabel.jpg', artikul: '3dMediumApplication' },
        { id: 'size_600x800', name: '600x800', price: 13000, imgSrc: 'resourses/tabel.jpg', artikul: '3dBigApplication' },
        { id: 'size_1200x2000', name: '1200x2000', price: 20000, imgSrc: 'resourses/tabel.jpg', artikul: '3dBigPlusApplication' },
    ...
    const handleAddToCart = async () => {
        ...
        const productToAdd = {
            ...
            name: `Фасадная табличка (Аппликация) (${selectedSizeData?.name || ''})`,
            price: totalPrice,
            quantity: quantity,
            description: 'Фасадная табличка с аппликацией для улицы',
            imageUrl: imageUrl,
