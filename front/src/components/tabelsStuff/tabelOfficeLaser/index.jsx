...
const TabOfficeLaser = () => {
    ...
    const sizes = [ // Renamed "osnastki" to "sizes" for clarity
        { id: 'size_200x100', name: '200x100', price: 2000, imgSrc: 'resourses/tabel.jpg', artikul: 'officeLaserSmall' },
        { id: 'size_300x150', name: '300x150', price: 2800, imgSrc: 'resourses/tabel.jpg', artikul: 'officeLaserMedium' },
        { id: 'size_400x200', name: '400x200', price: 3500, imgSrc: 'resourses/tabel.jpg', artikul: 'officeLaserLarge' },
        { id: 'size_500x250', name: '500x250', price: 4500, imgSrc: 'resourses/tabel.jpg', artikul: 'officeLaserXLarge' },
    ...
    const handleAddToCart = async () => {
        ...
        const productToAdd = {
            ...
            name: `Офисная табличка (Лазерная гравировка) (${selectedSizeData?.name || ''})`,
            price: totalPrice,
            quantity: quantity,
            description: 'Офисная табличка с лазерной гравировкой для помещений',
            imageUrl: imageUrl,
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.productInfoSection}> {/* General container for text part */}
                        <div className={styles.nazvanie}>
                            <h3>Офисная табличка (Лазерная гравировка)</h3>
                            <h4>Для помещений</h4>
                        </div>
